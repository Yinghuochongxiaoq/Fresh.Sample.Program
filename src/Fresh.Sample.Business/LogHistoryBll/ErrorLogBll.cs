...
using Fresh.Sample.DataAccess.LogDataAccess;
using Fresh.Sample.Interface.ILogHistoryBll;
using Fresh.Sample.Model.Enum;
using Fresh.Sample.Model.ErrorInfoLog;
using FreshCommonUtility.Cache;
using FreshCommonUtility.Configure;
using Microsoft.AspNetCore.Http;

namespace Fresh.Sample.Business.LogHistoryBll
{
    /// <summary>
    /// Deal error info
    /// </summary>
